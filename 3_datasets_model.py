...
ctr19 = pd.read_csv("ctr_15.csv")
ctr20 = pd.read_csv("ctr_16.csv")
ctr21 = pd.read_csv("ctr_17.csv")
ctr21 = pd.read_csv("ctr_18.csv")
ctr19 = pd.read_csv("ctr_19.csv")
ctr20 = pd.read_csv("ctr_20.csv")
ctr21 = pd.read_csv("ctr_21.csv")
train_data = pd.concat([ctr21, ctr20, ctr19], ignore_index=True)

# Load the test data
test_data = pd.read_csv("ctr_test.csv")

# Train a tree on the train data
train_data = train_data.sample(frac=1/10, random_state=1234)
y = train_data["Label"]
...
submission_df.to_csv("3_datasets_model.csv", sep=",", index=False)