...
train_data = train_data.sample(frac=1/21, random_state=2345)
y = train_data["Label"]
...
cls = make_pipeline(lgb.LGBMClassifier(n_estimators=150, 
                                       max_depth=14, 
                                       learning_rate=0.05, 
                                       boosting_type='dart', 
                                       random_state=2345,
...
submission_df.to_csv("lightGBM.csv", sep=",", index=False)